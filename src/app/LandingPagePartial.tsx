...
export const LandingPagePartial = () => (
  <div className="min-h-screen w-full flex flex-col items-center justify-center">
    ...
    <section className="w-full max-w-6xl flex-reverse lg:flex flex-col lg:flex-row items-center justify-between py-2 lg:py-8">
      <div className="lg:w-1/2 p-4 text-center lg:text-left animate__animated animate__zoomIn animate__delay-1s">
      ...
      <div className="lg:w-1/2 p-4 flex items-end justify-end animate__animated animate__zoomIn animate__delay-2s">
        <Image
